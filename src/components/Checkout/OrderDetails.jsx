...
const OrderDetails = () => {
  ...
  const handleClickOpen = (e, scrollType) => {
    e.preventDefault();
    console.log("This is DeliveryDates",deliveryDates?.data?.deliveries);
  ...
  const handlePlaceOrder = async () => {
    if (localStorage.getItem("data")) {
      console.log("shippingInfo", shippingInfo, "products", products, "itemPrice", itemPrice, "shippingPriceToSend", shippingPriceToSend, "totalPrice", totalPrice, "businessName", businessName, "businessAddress", businessAddress, "vat", vat, "createPayment", createPayment)
